...
<div class="container-fluid">
    ...
    <?php
        ...
        echo "<h3 class='text-center'>$event_day</h3>
              ...
              <center><div class='fb-share-button' data-href='http://localhost:63342/database_knights/Views/event_detail_page.php?eid=$event_id' data-layout='button_count'></div> <div class='g-plus' data-action='share' data-annotation='bubble'></div></center>
